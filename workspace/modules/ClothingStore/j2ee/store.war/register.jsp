   ...
   <body>
      <dsp:page>
         <div id="wrap" class="clear-block">
            ...
            <h3>register</h3>
            <div class="register">
               <div class="error">Please fill in all required info below in right format.</div>
                  ...
                  <table>
                     <tbody>
                        ...
                        <tr>
                           <td>Last Name *</td>
                           <td>
                              <dsp:input bean="ProfileFormHandler.value.lastName" maxlength="30" size="25" type="text" required="true"  />
                           </td>
                        </tr>
                        <tr>
                           <td>Email *</td>
                        ...
                        <tr>
                           ...
                           <td>
                              <dsp:input bean="ProfileFormHandler.value.confirmpassword" maxlength="30" size="25" type="password" required="true"  />
                           </td>
                        </tr>
                        <tr>
                           <td>Gender *</td>
                        ...
                        <tr>
                           <td>Day *</td>
                           <td>
                              <dsp:input bean="ProfileFormHandler.day" maxlength="30" size="25" type="text" required="true"  />
                           </td>
                           <td>Month *</td>
                           <td>
                              <dsp:input bean="ProfileFormHandler.month" maxlength="30" size="25" type="text" required="true"  />
                           </td>
                           <td>Month *</td>
                           <td>
                              <dsp:input bean="ProfileFormHandler.year" maxlength="30" size="25" type="text" required="true"  />
                           </td>
                        </tr>
                        <tr>
                           <td>
