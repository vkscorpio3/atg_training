...
drop table epub_tr_rep_tbl_mp;
drop table epub_table_map_sw;
drop table epub_tbl_map_onln;
drop table epub_table_mapping;
...
drop table dpi_user_sites;
drop table dpi_user_site_groups;
...
-- the source for this section is 
-- drop_create_system_config.sql



drop table das_sys_config;
...
-- the source for this section is 
-- drop_versioned_dynamic_metadata_ddl.sql



drop table das_gsa_dyn_prop_attr;
drop table das_gsa_dyn_prop_eorder;
drop table das_gsa_dyn_prop_enum;
drop table das_gsa_dyn_prop;
drop table das_gsa_dyn_type_attr;
drop table das_gsa_dyn_type;
...
-- the source for this section is 
-- drop_versioned_backing_maps_ddl.sql



drop table das_dyn_prop_map_long_2;
drop table das_dyn_prop_map_double_2;
drop table das_dyn_prop_map_big_str_2;
drop table das_dyn_prop_map_str_2;
drop table das_dyn_prop_map_long;
drop table das_dyn_prop_map_double;
drop table das_dyn_prop_map_big_str;
drop table das_dyn_prop_map_str;
