...
create table ARF_STORE (
	ID	number(5)	not null,
	NLOCATION_ID	varchar2(40)	not null,
	NAME	varchar2(254)	not null,
	NAME_EN	varchar2(254)	null,
...
create table ARF_COUPON (
	ID	number(10)	not null,
	NCOUPON_ID	varchar2(40)	not null,
	NAME	varchar2(254)	not null,
	NAME_EN	varchar2(254)	null,
	START_DATE	timestamp	null,
	EXPIRATION_DATE	timestamp	null,
	IS_BATCH	number(1)	default 0 not null,
	NUMBER_OF_COUPONS	number(10)	default 0 not null,
	RECORD_LAST_UPDATE	timestamp	null,
	RECORD_START_DATE	timestamp	null,
	RECORD_END_DATE	timestamp	null,
	MOST_RECENT	number(1)	default 1 not null,
...
create table ARF_LINE_ITEM (
	...
	IS_COUPON_APPLIED	number(1)	default 0 not null,
	ORGANIZATION_ID	number(10)	null,
	SEARCH_TERM_ID	number(10)	null,
	FACET_GROUP_ID	number(10)	null,
	MERCH_RULE_GROUP_ID	number(10)	null
...
create table ARF_PROMOTION_USAGE (
	...
	COUPON_USAGE_ID	number(19)	not null,
	COUPON_ID	number(10)	not null,
	COUPON_CODE	varchar2(254)	null,
	ORGANIZATION_ID	number(10)	null
...
create table ARF_APPEASEMENT (
	...
	NAPPEASEMENT_ID	varchar2(40)	not null,
	CUSTOMER_ID	number(10)	not null,
	AGENT_ID	varchar2(40)	not null,
	...
	SALES_CHANNEL_ID	number(3,0)	not null,
	SUBMITTED_SITE_ID	number(5)	not null,
	LOCAL_APPEASEMENT_AMOUNT	number(19,7)	not null,
	STD_APPEASEMENT_AMOUNT	number(19,7)	not null
